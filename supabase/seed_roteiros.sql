...
insert into public.po_roteiros
  (slug, titulo, subtitulo, descricao_curta, dias, data_label, local_label, badge, capa_url, video_id, valores, ordem, ativo)
values
  ('mercados-de-natal', 'Mercados de Natal',
   ...
   'assets/images/roteiro-mercados-natal.jpg', 'K6l4OFPdqkw',
  ...
  ('tesouros-asiaticos', 'Tesouros Asiáticos',
   ...
   'assets/images/roteiro-tesouros-asiaticos.jpg', 'S4Z-125K3_0',
  ...
  ('floracao-das-cerejeiras', 'Floração das Cerejeiras',
   ...
   'assets/images/roteiro-cerejeiras.jpg', '6gQV0HJALEE',
  ...
  ('grecia-terra-mar', 'Grécia Terra e Mar',
   ...
   'assets/images/roteiro-grecia.jpg', '8Z2kpec0TSE',
  ...
  ('encantos-do-mediterraneo', 'Encantos do Mediterrâneo',
   ...
   'assets/images/roteiro-mediterraneo.jpg', 'b5SY6WY498I',
